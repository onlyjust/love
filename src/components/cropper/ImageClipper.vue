    ...
    methods: {
        ...
        _initCanvas() {
            let $canvas = this.$refs.canvas,
                ...
                clipperWidth = parseInt(
                    this.clipperImgWidth / window.devicePixelRatio
                ),
            ...
            $gesture.addEventListener(
                ...
                e => {
                    ...
                    if (e.touches.length === 1) {
                        ...
                        figureDistance = this._pointDistance(
                            f1x,
                            f1y,
                            f2x,
                            f2y
                ...
                e => {
                    ...
                    if (e.touches.length === 1) {
                        ...
                        let finger1 = e.touches[0],
                            ...
                            f2x = finger2.pageX - cClientRect.left,
                            f2y = finger2.pageY - cClientRect.top,
                            newFigureDistance = this._pointDistance(
                                f1x,
                                f1y,
                                f2x,
                                f2y
