            ...
            <van-cell-group  title="基本资料">
                ...
                <van-popup v-model="showGenderPicker" position="bottom">
                    <van-picker
                            show-toolbar
                            :columns="genderList"
                            :default-index="defaultGenderIdx"
    ...
    export default {
        ...
        methods:{
            async initData(){
                ...
                if (result.success){
                    ...
                    if (this.datingBasic.gender == 1){
                        this.datingBasic.genderDesc = '男'
                    } else if (this.datingBasic.gender == 2){
                        this.datingBasic.genderDesc = '女'
                    }
                    // 收入
            ...
            async onSubmit(values) {
                ...
                values.gender = this.datingBasic.gender;
